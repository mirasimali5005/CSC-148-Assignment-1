...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        Preconditions: The phone line associated with the source phone number of
    ...
    def receive_call(self, call: Call) -> None:
        """Records that a call was made to the destination
        phone number of <call>.
        Preconditions: The phone line associated with
        the destination phone number
        of <call> is owned by this customer.
        """
        for phone_line in self._phone_lines:
