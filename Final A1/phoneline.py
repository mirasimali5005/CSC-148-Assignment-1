...
class PhoneLine:
    ...
    def make_call(self, call: Call) -> None:
        """
        Adds the <call> to this phone line's call history and bills it
        according to the contract for this phone line. If there is no bill
        for the current monthly billing cycle, then a new month must be
        started by advancing to the right month from <call>.
        """
